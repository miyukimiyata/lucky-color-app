...
.main-title { font-size: clamp(1.4rem, 5vw, 2.2rem); color: #007bb5; text-align: center; text-shadow: 1px 1px 2px #fff; margin-bottom: 5px; font-weight: bold; line-height: 1.3; }
